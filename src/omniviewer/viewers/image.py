...
#
# Отображает растровые изображения (PNG, JPEG, GIF, BMP, WebP, TIFF, ICO), векторные (SVG, SVGZ),
# современные HEIC/HEIF и AVIF (через Pillow → QImage), а также RAW-фото
# (CR2/CR3/NEF/ARW/DNG/RAF/ORF/RW2) — по встроенному превью-JPEG (быстрое отображение кадра).
# Многостраничный TIFF позволяет листать кадры.
