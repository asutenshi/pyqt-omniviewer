...
| Структура | JSON, YAML, XML, TOML — сворачиваемое дерево «ключ → значение → тип» (ленивое построение узлов + лимит детей, большой файл не подвешивает GUI); кнопка «дерево ⇄ текст» |
